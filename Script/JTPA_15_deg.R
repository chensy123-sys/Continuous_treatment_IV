...
target_point = 15; constriant = NULL; spline_k =4

delta <- delta_adap_func(mydat, target_point = target_point,constriant = constriant,h = 1)
Looptime <- 400
fit_CF_list = list()
...
save.image(file = paste0('data/JTPA_',target_point,'_deg.RDATA'))