...
load("data/LLKR_fit_1_10000.RData", envir = env1)
load("data/LLKR_fit_2_10000.RData", envir = env2)


LLKR_fit_list <- c(env1$LLKR_fit_list, env2$LLKR_fit_list)

Looptime <- length(LLKR_fit_list)
A_test<- seq(0.25,0.75,0.01)
...
library(patchwork)
ggsave("data/Figure6.1(b).pdf", plot = p_nuc + p_no_nuc + plot_layout(ncol = 2), width = 14, height = 5)
